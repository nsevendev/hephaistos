 ...
 */
final class Version20250214100445 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE engine_remap ADD info_description_model UUID NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_84CE46111469011');
        $this->addSql('ALTER TABLE engine_remap DROP info_description_model');
    }
}
