...
use Heph\Controller\Api\TermsConditions\CreateTermsConditions;
...
#[
    ...
    CoversClass(CreateTermsConditions::class),
...
class CreateTermsConditionsTest extends HephFunctionalTestCase
{
    ...
    public function testInvokeReturnResponseSucces(): void
    {
        ...
        $this->client->request('POST', '/api/terms-conditions', [], [], [], $payload);
