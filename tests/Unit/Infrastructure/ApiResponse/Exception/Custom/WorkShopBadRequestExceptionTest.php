...
use Heph\Infrastructure\ApiResponse\Exception\Custom\WorkShop\WorkShopBadRequestException;
...
#[
    ...
    CoversClass(WorkShopBadRequestException::class),
...
class WorkShopBadRequestExceptionTest extends HephUnitTestCase
{
    ...
    public function testOnKernelExceptionWorkShopBadRequestException(): void
    {
        $exceptionCustom = new WorkShopBadRequestException();
