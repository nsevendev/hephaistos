...
#[
    ...
    CoversClass(TermsConditionsInvalidArgumentException::class),
...
class TermsConditionsInvalidArgumentExceptionTest extends HephUnitTestCase
{
    ...
    public function testOnKernelExceptionTermsConditionsInvalidArgumentException(): void
    {
        $exceptionCustom = new TermsConditionsInvalidArgumentException();
