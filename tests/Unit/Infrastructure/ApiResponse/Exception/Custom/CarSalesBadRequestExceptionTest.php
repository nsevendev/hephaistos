...
namespace Heph\Tests\Unit\Infrastructure\ApiResponse\Exception\Custom\CarSales;
...
use Heph\Infrastructure\ApiResponse\Exception\Custom\CarSales\CarSalesBadRequestException;
...
#[
    ...
    CoversClass(CarSalesBadRequestException::class),
...
class CarSalesBadRequestExceptionTest extends HephUnitTestCase
{
    ...
    public function testOnKernelExceptionCarSalesBadRequestException(): void
    {
        $exceptionCustom = new CarSalesBadRequestException();
