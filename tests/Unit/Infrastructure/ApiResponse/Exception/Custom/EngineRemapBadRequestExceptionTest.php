...
namespace Heph\Tests\Unit\Infrastructure\ApiResponse\Exception\Custom\EngineRemap;
...
use Heph\Infrastructure\ApiResponse\Exception\Custom\EngineRemap\EngineRemapBadRequestException;
...
#[
    ...
    CoversClass(EngineRemapBadRequestException::class),
...
class EngineRemapBadRequestExceptionTest extends HephUnitTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->request = Request::create('/api/engine-remap');
    }

    public function testOnKernelExceptionEngineRemapBadRequestException(): void
    {
        $exceptionCustom = new EngineRemapBadRequestException();
