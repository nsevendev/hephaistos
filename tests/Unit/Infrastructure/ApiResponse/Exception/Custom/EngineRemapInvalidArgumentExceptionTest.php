...
class EngineRemapInvalidArgumentExceptionTest extends HephUnitTestCase
{
    ...
    public function testOnKernelExceptionEngineRemapInvalidArgumentException(): void
    {
        $exceptionCustom = new EngineRemapInvalidArgumentException();
