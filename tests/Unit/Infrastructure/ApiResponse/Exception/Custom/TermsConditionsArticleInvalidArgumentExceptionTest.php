...
class TermsConditionsArticleInvalidArgumentExceptionTest extends HephUnitTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->request = Request::create('/api/terms-conditions-article');
    }

    public function testOnKernelExceptionTermsConditionsArticleInvalidArgumentException(): void
    {
        $exceptionCustom = new TermsConditionsArticleInvalidArgumentException();
