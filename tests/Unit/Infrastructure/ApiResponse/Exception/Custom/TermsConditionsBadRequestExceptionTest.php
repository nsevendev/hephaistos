...
namespace Heph\Tests\Unit\Infrastructure\ApiResponse\Exception\Custom\TermsConditions;
...
use Heph\Infrastructure\ApiResponse\Exception\Custom\TermsConditions\TermsConditionsBadRequestException;
...
#[
    ...
    CoversClass(TermsConditionsBadRequestException::class),
...
class TermsConditionsBadRequestExceptionTest extends HephUnitTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->request = Request::create('/api/terms-conditions');
    }

    public function testOnKernelExceptionTermsConditionsBadRequestException(): void
    {
        $exceptionCustom = new TermsConditionsBadRequestException();
