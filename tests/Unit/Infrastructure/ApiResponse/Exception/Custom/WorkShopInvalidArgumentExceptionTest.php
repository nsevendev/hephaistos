...
#[
    ...
    CoversClass(WorkShopInvalidArgumentException::class),
...
class WorkShopInvalidArgumentExceptionTest extends HephUnitTestCase
{
    ...
    public function testOnKernelExceptionWorkShopInvalidArgumentException(): void
    {
        $exceptionCustom = new WorkShopInvalidArgumentException();
